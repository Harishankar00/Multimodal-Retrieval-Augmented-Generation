...
export default function ChatPane({ chatId, docId, activeBlock, setActiveBlock, setActivePage, onViewDocument, activeChatDocuments }) {
  ...
  return (
    <div className="chat-container">
      {/* Scrollable chat history feed stretching 100% width */}
      <div className="chat-history">
        {/* Centered inner layout bounds for scrollable messages */}
        <div style={{
          width: "100%",
          maxWidth: "800px",
          margin: "0 auto",
          ...
          {messages.length === 0 ? (
            <div style={{ margin: "auto", textAlign: "center", color: "var(--text-muted)", fontSize: "14px", maxWidth: "400px", paddingTop: "40px" }}>
      ...
      {/* Centered Usage metrics banner container */}
      ...
      {/* Centered Input bar form container */}
      <div style={{
        width: "100%",
